...
public class MemberVO {
	...
	public MemberVO(String id, String pwd, String name, String phone, String email, String picture, String address,
			Date regDate, String register, String authority, int enabled) {
		super();
		this.id = id;
		this.pwd = pwd;
		this.name = name;
